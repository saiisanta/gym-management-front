...
    if (user) {
      const normalizedPlanId = user.PlanId
        ? Number(user.PlanId)
        : user.planId
        ? Number(user.planId)
        : null;
      let calculatedPlanName = "Sin plan";
      if (normalizedPlanId) {
        calculatedPlanName = mapPlanIdToName(normalizedPlanId);
      } else if (user.planName && user.planName !== "Sin plan") {
        calculatedPlanName = user.planName;
      }
...
          planId: updatedUser.planId ?? updatedUser.PlanId ?? null,
          planName:
            updatedUser.planId || updatedUser.PlanId
              ? mapPlanIdToName(Number(updatedUser.planId ?? updatedUser.PlanId))
              : updatedUser.planName ?? updatedUser.PlanName ?? "Sin plan",
            
